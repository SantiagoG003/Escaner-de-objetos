...
# Definir el cuadro central en coordenadas (70% del ancho y alto del video)
...
detected_object = "" # variable que se le debe pasar al esp 32 para que de la salida de audio
...
while cap.isOpened():
    ...
    if cv2.waitKey(1) & 0xFF == ord('c'):
        ...
        for result in results[0].boxes:
            ...
            # Verificar si la caja detectada está dentro del cuadro verde
            if (x1 >= box_x1 and y1 >= box_y1 and x2 <= box_x2 and y2 <= box_y2):
                ...
                detected_object = f'Objeto: {class_name}'
